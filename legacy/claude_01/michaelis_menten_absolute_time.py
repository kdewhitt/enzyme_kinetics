...
def create_time_unit_plots(results_df, output_dir):
    ...
    bars = ax.bar(peaks, valid_results['kcat_over_km_per_sec_per_um'].values, color=colors, alpha=0.7, edgecolor='black', linewidth=2)
    ...
    width = 0.35
    ax.bar(x - width/2, valid_results['Vmax_per_hour'].values, width, label='Per hour', 
           color='steelblue', alpha=0.7, edgecolor='black', linewidth=1.5)
    ax.bar(x + width/2, valid_results['Vmax_per_sec'].values * 3600, width, label='Per sec (scaled)', 
    ...
    ax.text(0.5, 1.1, 'Enzyme Kinetics Summary (Ranked by Catalytic Efficiency)',
